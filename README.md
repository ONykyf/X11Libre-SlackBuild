...
Now, once XLibre xserver and drivers have been included by The Man into Slackware-current /testing directory, which is clearly a GREAT THING, the goal of this repository has been changed. The packages [officially provided](https://slackware.zero.com.ar/slackware/slackware64-current/testing/packages/xlibre/) by Slackware follow the long-standing general principle: all software is kept as “vanilla” as possible, with exceptions possible mostly for rare patches adopted long time ago. Chances are good that you will encounter no problems, as XLibre is mature enough now.
